...
#if defined(NDEBUG)
# error "Specie cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Specie Signed Message:\n";
...
#ifdef ENABLE_WALLET
// Specie: attempt to generate suitable proof-of-stake
