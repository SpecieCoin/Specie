...
static const int MODIFIER_INTERVAL_SWITCH = 131;

inline bool IsProtocolVCurrent(int nHeight) { return TestNet() || nHeight > 134; }
...
inline unsigned int GetTargetSpacing(int nHeight) { return IsProtocolVCurrent(nHeight) ? 120 : 120; }
